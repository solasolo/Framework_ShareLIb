...
namespace GLEO.UI
{
    public class GridViewPrinter : PrintDocument
    {
        ...
        public void Print(DataGridView dgv1, PrintOptions opts)
        {
            this.PrintTitle = opts.PrintTitle;
            this.PrintAllRows = opts.PrintAllRows;
            this.FitToPageWidth = opts.FitToPageWidth;
            ...
            PrintDialog ppvw = new PrintDialog();
            ppvw.Document = this;

            // Showing the Print Preview Page
            if (ppvw.ShowDialog() == DialogResult.OK)
            {
                this.PrinterSettings = ppvw.PrinterSettings;
        ...
        protected override void OnBeginPrint(PrintEventArgs e)
        {
            ...
            foreach (DataGridViewColumn GridCol in dgv.Columns)
            {
                ...
                if (!this.SelectedColumns.Contains(GridCol.HeaderText)) continue;
            ...
            while (RowPos <= dgv.Rows.Count - 1)
            {
                ...
                else
                {
                    if (NewPage)
                    {
                        ...
                        {
                            if (!GridCol.Visible) continue;
                            if (!this.SelectedColumns.Contains(GridCol.HeaderText))
                                continue;
    ...
    public class PrintOptions
    {
        ...
        public PrintOptions(string title)
        {
            this.SelectedColumns = null;
            this.PrintTitle = title;
            this.FitToPageWidth = true;
        }
    }
}
